                  ...
                  Container(
                    ...
                    child: Row(mainAxisAlignment: MainAxisAlignment.end, children: [
                      TextButton(
                        ...
                        child: Text(
                          "Forgot Password?",
                          style: TextStyle(color: Colors.pink[400], fontStyle: FontStyle.italic, fontSize: 10),
                        ),
                      )
                    ]),
                  ),
                  ...
                  Container(
                    ...
                    child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                      ...
                      GestureDetector(
                        ...
                        child: Text(
                          "Sign Up",
                          style: TextStyle(fontSize: 10, fontWeight: FontWeight.bold, color: Colors.pink[400]),
                        ),
                      )
                    ]),
                  )
